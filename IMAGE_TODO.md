...
| 神奈川県-鎌倉市 | 鎌倉市 | 神奈川県 | 古都の寺社と海辺の散策を楽しむ・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/kamakura-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
| 神奈川県-箱根町 | 箱根町 | 神奈川県 | 温泉と美術館、山の絶景に癒やされる・温泉・山 | 既存jpgあり / 要確認 | /images/destinations/hakone-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 群馬県-草津町 | 草津町 | 群馬県 | 名湯と風情ある温泉街をゆっくり歩く・温泉・山 | 既存jpgあり / 要確認 | /images/destinations/kusatsu-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 宮城県-仙台市 | 仙台市 | 宮城県 | 歴史スポットと仙台名物を楽しむ・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/sendai-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 静岡県-熱海市 | 熱海市 | 静岡県 | 温泉と海鮮、海辺の景色を満喫・温泉・海 | 既存jpgあり / 要確認 | /images/destinations/atami-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
| 石川県-金沢市 | 金沢市 | 石川県 | 歴史ある街並みと北陸の美食を楽しむ・グルメ・カップル向け | 既存jpgあり / 要確認 | /images/destinations/kanazawa-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 京都府-京都市 | 京都市 | 京都府 | 古都の寺社と四季の風景を巡る・山・グルメ | 既存jpgあり / 要確認 | /images/destinations/kyoto-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 福岡県-福岡市 | 福岡市 | 福岡県 | 屋台グルメと海辺の都市景観を楽しむ・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/fukuoka-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 大分県-別府市 | 別府市 | 大分県 | 湯けむりの街で多彩な温泉を体験・温泉・海 | 既存jpgあり / 要確認 | /images/destinations/beppu-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 北海道-小樽市 | 小樽市 | 北海道 | 運河沿いのレトロな街並みと寿司を楽しむ・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/otaru-hero.jpg | needs_review | 最優先。既存ローカル画像を固定heroとして使用中。WebP化と権利確認を継続。 |
...
| 岐阜県-下呂市 | 下呂市 | 岐阜県 | 日本三名泉と飛騨の山里グルメに癒やされる・温泉・山 | 未作成 | /images/destinations/destination-038/hero.webp | missing | 最優先。専用hero作成後に destinationImages の対応表へ登録。 |
...
| 徳島県-鳴門市 | 鳴門市 | 徳島県 | 最寄り駅からバス・車移動が必要・春,夏・海・グルメ | 未作成 | /images/destinations/destination-071/hero.webp | missing | 最優先。専用hero作成後に destinationImages の対応表へ登録。 |
...
| 埼玉県-川越市 | 川越市 | 埼玉県 | 駅から蔵造りエリアへバス・徒歩で移動しやすい・春,秋,冬・グルメ・カップル向け | 未作成 | /images/destinations/destination-093/hero.webp | missing | 最優先。専用hero作成後に destinationImages の対応表へ登録。 |
...
| 長野県-上田市 | 上田市 | 長野県 | 駅から中心街へ移動しやすい・春,秋,冬・山・グルメ | 未作成 | /images/destinations/destination-101/hero.webp | missing | 最優先。専用hero作成後に destinationImages の対応表へ登録。 |
...
| 山梨県-甲府市 | 甲府市 | 山梨県 | 駅周辺を起点にしやすい・春,秋,冬・山・グルメ | 未作成 | /images/destinations/destination-104/hero.webp | missing | 通常。専用hero作成後に destinationImages の対応表へ登録。 |
