...
下呂市、京都市、小樽市、箱根町、草津町、熱海市、金沢市、鎌倉市、仙台市、福岡市、鳴門市、別府市、甲府市、川越市、佐野市、上田市に軽量SVGの旅先イメージビジュアルを追加しました。佐野市は現行の旅行先データには未登録ですが、画像ファイルと `destinationImages` 側の対応は先行作成済みです。品質確認で画像内の表示テキストは外し、SVGの `<title>` / `<desc>` と画像メタ情報だけで「イメージビジュアル」として扱います。
