...
石垣市、宮古島市、札幌市、函館市、長崎市、広島市、廿日市市、高山市、尾道市、倉敷市、松江市、由布市、松山市、神戸市、豊岡市、尾花沢市に軽量SVGの旅先イメージビジュアルを追加しました。第1弾と同じく画像内に旅先名の大きな文字は入れず、SVGの `<title>` / `<desc>` と画像メタ情報で「イメージビジュアル」として扱います。
...
|---|---|---|---|---|---|---|---|
| 神奈川県-横浜市 | 横浜市 | 神奈川県 | 港町の景色と多彩なグルメを満喫・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/yokohama-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 神奈川県-鎌倉市 | 鎌倉市 | 神奈川県 | 鶴岡八幡宮・江ノ電・海・古都散策 | rejected | /images/destinations/kamakura/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 神奈川県-箱根町 | 箱根町 | 神奈川県 | 芦ノ湖・箱根神社・山並み・温泉 | rejected | /images/destinations/hakone/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 栃木県-日光市 | 日光市 | 栃木県 | 世界遺産と豊かな自然を一度に巡る・温泉・山 | 既存jpgあり / 要確認 | /images/destinations/nikko-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 群馬県-草津町 | 草津町 | 群馬県 | 湯畑・湯けむり・温泉街・夜の灯り | rejected | /images/destinations/kusatsu/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 宮城県-仙台市 | 仙台市 | 宮城県 | 杜の都・青葉城跡・牛タン・街と緑 | rejected | /images/destinations/sendai/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 宮城県-松島町 | 松島町 | 宮城県 | 日本三景の島々と新鮮な海鮮に出会う・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/matsushima-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
...
| 福島県-会津若松市 | 会津若松市 | 福島県 | 城下町の歴史と会津グルメに触れる・温泉・山 | 既存jpgあり / 要確認 | /images/destinations/aizuwakamatsu-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 静岡県-熱海市 | 熱海市 | 静岡県 | 海・温泉街・坂道・レトロ観光地 | rejected | /images/destinations/atami/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 石川県-金沢市 | 金沢市 | 石川県 | 兼六園・ひがし茶屋街・金箔感・しっとりした街並み | rejected | /images/destinations/kanazawa/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 岐阜県-高山市 | 高山市 | 岐阜県 | 古い町並み・飛騨の山並み・朝市・和の街歩き | rejected | /images/destinations/takayama/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 京都府-京都市 | 京都市 | 京都府 | 寺社・石畳・町家・和の雰囲気 | rejected | /images/destinations/kyoto/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 兵庫県-神戸市 | 神戸市 | 兵庫県 | 有馬温泉の温泉街・坂道・金泉銀泉の雰囲気 | rejected | /images/destinations/arima-onsen/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 奈良県-奈良市 | 奈良市 | 奈良県 | 古寺と鹿に出会う穏やかな古都旅・山・グルメ | 既存jpgあり / 要確認 | /images/destinations/nara-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 和歌山県-白浜町 | 白浜町 | 和歌山県 | 白い砂浜と温泉、海の絶景を満喫・温泉・海 | 既存jpgあり / 要確認 | /images/destinations/shirahama-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 兵庫県-豊岡市 | 豊岡市 | 兵庫県 | 城崎温泉の柳並木・外湯めぐり・浴衣散策・川沿いの温泉街 | rejected | /images/destinations/kinosaki-onsen/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 福岡県-福岡市 | 福岡市 | 福岡県 | 屋台・博多ラーメン・夜の街・港町感 | rejected | /images/destinations/fukuoka/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 長崎県-長崎市 | 長崎市 | 長崎県 | 異国情緒・坂の街・港・夜景 | rejected | /images/destinations/nagasaki/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 大分県-別府市 | 別府市 | 大分県 | 湯けむり・地獄めぐり・温泉街・坂のある街 | rejected | /images/destinations/beppu/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 大分県-由布市 | 由布市 | 大分県 | 由布岳・温泉街・金鱗湖・ゆったり散策 | rejected | /images/destinations/yufuin/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 北海道-札幌市 | 札幌市 | 北海道 | 大通公園・札幌時計台・雪景色・都市と自然 | rejected | /images/destinations/sapporo/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 北海道-函館市 | 函館市 | 北海道 | 函館山夜景・赤レンガ倉庫・港町・坂道 | rejected | /images/destinations/hakodate/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 北海道-小樽市 | 小樽市 | 北海道 | 小樽運河・倉庫群・港町・夜景の雰囲気 | rejected | /images/destinations/otaru/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 岐阜県-下呂市 | 下呂市 | 岐阜県 | 温泉街・川沿い・足湯・やわらかい湯けむり | rejected | /images/destinations/gero-onsen/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 広島県-広島市 | 広島市 | 広島県 | 原爆ドーム風シルエット・川と橋・路面電車 | rejected | /images/destinations/hiroshima/hero.svg | rejected | 簡易SVGで広島らしさ・旅行アプリとしての魅力が不足するため一般画面非表示。次回は原爆ドーム、平和記念公園、川沿い、路面電車、橋、都市観光感を高品質画像で作り直す。 |
| 広島県-廿日市市 | 廿日市市 | 広島県 | 厳島神社・海上鳥居・瀬戸内海・鹿のいる島の雰囲気 | rejected | /images/destinations/miyajima/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 岡山県-倉敷市 | 倉敷市 | 岡山県 | 美観地区・白壁の町並み・柳並木・川舟の雰囲気 | rejected | /images/destinations/kurashiki/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 愛媛県-松山市 | 松山市 | 愛媛県 | 道後温泉本館・温泉街・レトロ建築・夜の灯り | rejected | /images/destinations/dogo-onsen/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 沖縄県-那覇市 | 那覇市 | 沖縄県 | 琉球の歴史と南国グルメを満喫・海・グルメ | 既存jpgあり / 要確認 | /images/destinations/naha-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
| 沖縄県-石垣市 | 石垣市 | 沖縄県 | 青い海・白い砂浜・川平湾・南国の空気感 | rejected | /images/destinations/ishigaki/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 山形県-尾花沢市 | 尾花沢市 | 山形県 | 銀山温泉の大正ロマン・雪景色・ガス灯・木造旅館街 | rejected | /images/destinations/ginzan-onsen/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 三重県-伊勢市 | 伊勢市 | 三重県 | 駅から内宮方面への移動時間を加算・春,秋・グルメ・カップル向け | 既存jpgあり / 要確認 | /images/destinations/ise-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
...
| 島根県-松江市 | 松江市 | 島根県 | 松江城・宍道湖・水辺の街・夕景 | rejected | /images/destinations/matsue/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 徳島県-鳴門市 | 鳴門市 | 徳島県 | 渦潮・鳴門海峡・橋・海の迫力 | rejected | /images/destinations/naruto/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 長野県-軽井沢町 | 軽井沢町 | 長野県 | 駅から旧軽井沢への移動時間を加算・春,夏,秋・山・グルメ | 既存jpgあり / 要確認 | /images/destinations/karuizawa-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
...
| 沖縄県-宮古島市 | 宮古島市 | 沖縄県 | 宮古ブルーの海・伊良部大橋・砂浜・リゾート感 | rejected | /images/destinations/miyakojima/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
| 北海道-富良野市 | 富良野市 | 北海道 | 駅から丘陵・花畑エリアへの移動時間を加算・夏,秋・山・グルメ | 既存jpgあり / 要確認 | /images/destinations/furano-hero.jpg | needs_review | 通常。既存ローカル画像を固定hero候補として管理中。品質確認が完了するまで一般画面では非表示。WebP化と権利確認を継続。 |
...
| 広島県-尾道市 | 尾道市 | 広島県 | 坂道・瀬戸内海・しまなみ海道・レトロな街並み | rejected | /images/destinations/onomichi/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 埼玉県-川越市 | 川越市 | 埼玉県 | 蔵造りの町並み・時の鐘・菓子屋横丁・レトロ街歩き | rejected | /images/destinations/kawagoe/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 長野県-上田市 | 上田市 | 長野県 | 上田城跡・真田・城下町・信州の山並み | rejected | /images/destinations/ueda/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 山梨県-甲府市 | 甲府市 | 山梨県 | 甲府城跡・昇仙峡・ぶどう畑・山梨の山並み | rejected | /images/destinations/kofu/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
...
| 栃木県-佐野市 | 佐野市 | 栃木県 | 佐野ラーメン・厄除け大師・日帰り街歩き | rejected | /images/destinations/sano/hero.svg | rejected | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 |
