...
- 現在の登録旅先: 120件
- 固定hero登録あり: 42件
- 一般画面に表示するconfirmed hero: 34件
- needs_review hero: 6件
- rejected hero: 2件
- missing hero: 78件
