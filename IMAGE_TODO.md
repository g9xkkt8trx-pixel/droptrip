...
| 神奈川県-鎌倉市 | 鎌倉市 | 神奈川県 | 江ノ電・海・古都・寺社・紫陽花 | rejected | /images/destinations/kamakura/hero-v1.webp | - | ai_generated | 画像内に説明文が入っているため、一般画面では非表示。文字なし高品質画像で再作成する。 | 画像内テキストがあり、アプリ側UIと重複してトリミング時に切れる可能性がある。旧hero.svgも簡易SVGのため未使用。 | 江ノ電、海、古都、寺社、紫陽花を含み、画像内文字のない鎌倉らしい古都散策のビジュアルへ作り直す。 |
...
| 宮城県-仙台市 | 仙台市 | 宮城県 | 杜の都・青葉城跡・街と緑・都市景観 | rejected | /images/destinations/sendai/hero-v1.webp | - | ai_generated | 画像内に説明文が入っているため、一般画面では非表示。文字なし高品質画像で再作成する。 | 画像内テキストがあり、アプリ側UIと重複してトリミング時に切れる可能性がある。旧hero.svgも簡易SVGのため未使用。 | 街並み、緑、歴史、都市景観を含み、画像内文字のない仙台らしいビジュアルへ作り直す。 |
...
| 静岡県-熱海市 | 熱海市 | 静岡県 | 海辺温泉・坂道・リゾート温泉街・夕景 | rejected | /images/destinations/atami/hero-v1.webp | - | ai_generated | 画像内に説明文が入っているため、一般画面では非表示。文字なし高品質画像で再作成する。 | 画像内テキストがあり、アプリ側UIと重複してトリミング時に切れる可能性がある。旧hero.svgも簡易SVGのため未使用。 | 海辺温泉、坂道、リゾート温泉街、夕景を含み、画像内文字のない熱海らしいビジュアルへ作り直す。 |
...
| 福岡県-福岡市 | 福岡市 | 福岡県 | 屋台・夜景・博多グルメ・川沿い | rejected | /images/destinations/fukuoka/hero-v1.webp | - | ai_generated | 画像内に説明文が入っているため、一般画面では非表示。文字なし高品質画像で再作成する。 | 画像内テキストがあり、アプリ側UIと重複してトリミング時に切れる可能性がある。旧hero.svgも簡易SVGのため未使用。 | 屋台、夜景、博多グルメ、川沿いを含み、画像内文字のない福岡らしい夜のビジュアルへ作り直す。 |
...
| 北海道-札幌市 | 札幌市 | 北海道 | 大通公園・札幌時計台・雪景色・都市と自然 | rejected | /images/destinations/sapporo/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 大通公園・札幌時計台・雪景色・都市と自然をもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
| 北海道-函館市 | 函館市 | 北海道 | 函館山夜景・赤レンガ倉庫・港町・坂道 | rejected | /images/destinations/hakodate/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 函館山夜景・赤レンガ倉庫・港町・坂道をもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
...
| 沖縄県-石垣市 | 石垣市 | 沖縄県 | 青い海・白い砂浜・川平湾・南国の空気感 | rejected | /images/destinations/ishigaki/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 青い海・白い砂浜・川平湾・南国の空気感をもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
...
| 徳島県-鳴門市 | 鳴門市 | 徳島県 | 渦潮・鳴門海峡・橋・海の迫力 | rejected | /images/destinations/naruto/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 渦潮・鳴門海峡・橋・海の迫力をもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
...
| 沖縄県-宮古島市 | 宮古島市 | 沖縄県 | 宮古ブルーの海・伊良部大橋・砂浜・リゾート感 | rejected | /images/destinations/miyakojima/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 宮古ブルーの海・伊良部大橋・砂浜・リゾート感をもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
...
| 埼玉県-川越市 | 川越市 | 埼玉県 | 蔵造りの町並み・時の鐘・菓子屋横丁・レトロ街歩き | rejected | /images/destinations/kawagoe/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 蔵造りの町並み・時の鐘・菓子屋横丁・レトロ街歩きをもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
...
| 山梨県-甲府市 | 甲府市 | 山梨県 | 甲府城跡・昇仙峡・ぶどう畑・山梨の山並み | rejected | /images/destinations/kofu/hero.svg | - | ai_generated | 作成済みだが一般画面非表示。高品質画像で再作成する。 | 簡易SVGのため一般画面非表示。旅先固有要素と旅行アプリheroとしての魅力を高品質画像で再作成する。 | 甲府城跡・昇仙峡・ぶどう畑・山梨の山並みをもとに、汎用背景に見えない高品質hero画像へ作り直す。 |
