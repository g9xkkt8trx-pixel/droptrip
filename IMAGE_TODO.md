...
最終監査結果: confirmed 125件、`shouldShowHero: true` 125件、`image_missing` 11件、`needs_review` 1件、`registration_fix_needed` 0件、`file_missing` 0件。次の生成対象と推奨slugは `FINAL_HERO_REMAINING.md` を参照します。
