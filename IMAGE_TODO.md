...
千葉市、銚子市、成田市、姫路市、岐阜市、沼津市、山中湖村、佐野市、佐渡市、小布施町、三浦市、逗子市、葉山町、川口市、さいたま市、越谷市、宇都宮市、諏訪市、日立市、土浦市、米沢市、福島市、渋川市、佐賀県白石町、南さつま市、諫早市、大村市、かほく市、羽咋市は、画像と登録キーはありますが、現行の `destinations.js` からは解決されません。画像を削除せず、旅先データに追加された時点で正式対象へ移します。
...
| 栃木県-那須塩原市 | 那須塩原市 | 栃木県 | 温泉と自然、高原カフェを満喫・温泉・山 | confirmed | /images/destinations/nasushiobara/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 宮城県-松島町 | 松島町 | 宮城県 | 松島湾・島々・松・遊覧船・朝夕の光 | confirmed | /images/destinations/matsushima-miyagi/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 沖縄県-那覇市 | 那覇市 | 沖縄県 | 首里城周辺・琉球建築・石畳・南国の青空 | confirmed | /images/destinations/naha/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 長崎県-佐世保市 | 佐世保市 | 長崎県 | 九十九島の絶景と港町グルメを満喫・海・グルメ | confirmed | /images/destinations/sasebo/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 秋田県-仙北市 | 仙北市 | 秋田県 | 駅から観光エリアへの移動時間を加算・春,秋,冬・山・温泉 | confirmed | /images/destinations/semboku/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 新潟県-湯沢町 | 湯沢町 | 新潟県 | 駅周辺・夏,秋,冬・温泉・山 | confirmed | /images/destinations/yuzawa/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 富山県-富山市 | 富山市 | 富山県 | 駅から中心市街地への移動時間を加算・春,秋,冬・山・グルメ | confirmed | /images/destinations/toyama/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 富山県-立山町 | 立山町 | 富山県 | 山岳観光の乗り換え時間を加算・夏,秋・山・温泉 | confirmed | /images/destinations/tateyama-toyama/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 館山市と別画像。一般画面表示OK。 |
...
| 福井県-坂井市 | 坂井市 | 福井県 | 最寄り駅からバス・車移動が必要・春,夏,秋・海・グルメ | confirmed | /images/destinations/sakai/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 三重県-鳥羽市 | 鳥羽市 | 三重県 | 駅から海辺の観光地への移動時間を加算・春,夏,秋・海・温泉 | confirmed | /images/destinations/toba/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 滋賀県-高島市 | 高島市 | 滋賀県 | 琵琶湖・メタセコイア並木・山並み・湖畔 | confirmed | /images/destinations/takashima/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 山口県-下関市 | 下関市 | 山口県 | 関門海峡・関門橋・港町・海峡の景色 | confirmed | /images/destinations/shimonoseki/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 山口県-萩市 | 萩市 | 山口県 | 城下町・白壁・夏みかん・歴史的町並み | confirmed | /images/destinations/hagi/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 徳島県-三好市 | 三好市 | 徳島県 | 祖谷渓・かずら橋・山・渓谷・秘境 | confirmed | /images/destinations/miyoshi/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 佐賀県-佐賀市 | 佐賀市 | 佐賀県 | 佐賀城周辺・平野・水辺・城下町 | confirmed | /images/destinations/saga/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 佐賀県-嬉野市 | 嬉野市 | 佐賀県 | 嬉野温泉・川・茶畑・湯けむり・温泉街 | confirmed | /images/destinations/ureshino/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 福岡県-北九州市 | 北九州市 | 福岡県 | 門司港レトロ・赤れんが・港・海峡・歴史建築 | confirmed | /images/destinations/kitakyushu/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 岐阜県-郡上市 | 郡上市 | 岐阜県 | 郡上八幡・清流・石畳・城下町・山あい | confirmed | /images/destinations/gujo/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 兵庫県-明石市 | 明石市 | 兵庫県 | 明石海峡大橋・海岸・港・淡路島方面の海景色 | confirmed | /images/destinations/akashi/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
...
| 岡山県-津山市 | 津山市 | 岡山県 | 津山城跡・石垣・桜・城下町・中国山地 | confirmed | /images/destinations/tsuyama/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 山口県-山口市 | 山口市 | 山口県 | 瑠璃光寺五重塔・池・庭園・歴史景観・緑豊かな街 | confirmed | /images/destinations/yamaguchi/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 広島県-竹原市 | 竹原市 | 広島県 | 町並み保存地区・白壁・石畳・古い町並み・瀬戸内 | confirmed | /images/destinations/takehara/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 香川県-丸亀市 | 丸亀市 | 香川県 | 丸亀城・石垣・城下町・瀬戸内海方面の眺望 | confirmed | /images/destinations/marugame/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 愛媛県-今治市 | 今治市 | 愛媛県 | しまなみ海道・来島海峡大橋・島々・青い海・港町 | confirmed | /images/destinations/imabari/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
| 徳島県-徳島市 | 徳島市 | 徳島県 | 眉山・吉野川・市街地・水辺・山と街 | confirmed | /images/destinations/tokushima/hero-v1.webp | - | ai_generated | ユーザー確認済み。文字なし高品質AI生成hero画像としてconfirmed登録。 | 2026-07-13 | 一般画面表示OK。現地写真と誤認させない。 |
