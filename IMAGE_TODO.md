...
## 2026-07-03 映え・トレンド画像の扱い

- 映え・トレンドページは、まず画像なしで運用します。旅先専用・項目専用の権利確認済み画像がない場合は画像枠を出しません。
- Instagram、SNS投稿、外部サイト画像、直リンク画像、権利不明画像は使用しません。
- 店舗・施設画像は、公式素材、自前撮影、利用許諾済み素材のみ追加対象にします。
- 映え・トレンド用に優先したい画像: 下呂プリン、ゆあみ屋周辺、祇園白川、小樽運河、湯畑、熱海プリン、ひがし茶屋街、川越一番街、渦の道、川平湾、与那覇前浜ビーチ、宮島表参道商店街、倉敷美観地区、道後温泉本館周辺、城崎温泉街。
- 画像を追加する場合は、現地写真かイメージ画像かを明確にし、現地写真と誤認させるaltや説明を避けます。
