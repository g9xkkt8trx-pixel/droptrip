...
| `photoSpots` | 専用構造 | 8 | 24 | confirmedのみを「映え」詳細に表示 |
...
- 対象旅先: 那覇市、石垣市、宮古島市、本部町、箱根町、京都市、小樽市、函館市
- confirmed: 24件
- needs_review: 0件
- draft: 0件
- 情報源URL: 24件。`sourceName`と`sourceUrl`は監査用に保持し、一般画面には表示しません。

第1弾は沖縄県の4旅先・12件、第2弾は箱根町・京都市・小樽市・函館市の4旅先・12件です。
