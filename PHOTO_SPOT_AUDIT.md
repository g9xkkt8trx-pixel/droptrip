...
| `photoSpots` | 専用構造 | 78 | 234 | confirmedのみを「映え」詳細に表示 |
...
- needs_review: 0件
- draft: 0件
- 情報源URL: 234件。`sourceName`と`sourceUrl`は監査用に保持し、一般画面には表示しません。

第1弾は沖縄県の4旅先・12件、第2弾は箱根町・京都市・小樽市・函館市の4旅先・12件、第3弾は横浜市など10旅先・30件、第4弾は奈良市など15旅先・45件です。第7弾は名古屋市など15旅先・45件を、第1工程5旅先と残り10旅先に分けて重複なく登録しました。
