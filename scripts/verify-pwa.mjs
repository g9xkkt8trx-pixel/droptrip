...
try {
  for (const path of ['manifest.webmanifest', 'service-worker.js', 'offline.html', 'icons/droptrip-192.png', 'icons/droptrip-512.png', 'icons/droptrip-apple-touch-icon.png', 'robots.txt']) await access(dist(path))
